...
type Display = Ssd1306<I2cInterface<I2cDriver>, DisplaySize, BufferedGraphicsMode<DisplaySize>>;
type T = BitmapFontStyle<'static, 'static, BinaryColor, BinaryColor, 1>;
type TextWriter = display::TextWriter<'static, Display, T, CriticalSectionRawMutex, N, 1, 3, 1>;
...
#[embassy_executor::task]
async fn display_task(mut text_writer: TextWriter) -> ! {
